...
bool elements::tab(const char* name, bool boolean)
{
    ...
    window->DrawList->AddRectFilled(ImVec2(rect.Max.x + 4, rect.Min.y + 6), ImVec2(rect.Max.x + 8, rect.Max.y - 6), ImColor(menu::main_color[0], menu::main_color[1], menu::main_color[2], it_anim->second.rect_opacity), 7.0f, ImDrawFlags_RoundCornersLeft);
...
bool elements::subtab(const char* name, bool boolean)
{
    ...
    window->DrawList->AddRectFilled(ImVec2(rect.Max.x + 5, rect.Min.y + 9), ImVec2(rect.Max.x + 8, rect.Max.y - 9), ImColor(menu::main_color[0], menu::main_color[1], menu::main_color[2], it_anim->second.rect_opacity), 10.0f, ImDrawFlags_RoundCornersLeft);
